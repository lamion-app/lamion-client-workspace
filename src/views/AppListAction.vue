  ...
  <article>
    ...
    >
      ...
      <md-table-toolbar slot="md-table-alternate-header" slot-scope="{ count }">
        ...
        <div class="md-toolbar-section-end">
          <md-button
            ...
            v-on:click="appsDeleteAttempt = true"
          >
      ...
      >
        ...
        <md-table-cell md-label="Название" md-sort-by="title" class="title">{{
          item.title
        }}</md-table-cell>
        <md-table-cell md-label="Дата создания" md-sort-by="date">{{
          item.date
        }}</md-table-cell>
        <md-table-cell md-label="Количество событий" md-sort-by="eventsCount">{{
          item.eventsCount
        }}</md-table-cell>
        <md-table-cell
    ...
    <md-dialog-confirm
      ...
      v-model:md-active="appsDeleteAttempt"
